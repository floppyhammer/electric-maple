...
GLSwapchain::enumerateAndGenerateFramebuffers(XrSwapchain swapchain)
{
	...
	//            {XR_TYPE_SWAPCHAIN_IMAGE_OPENGL_ES_KHR}); std::vector<XrSwapchainImageBaseHeader*>
	//            swapchainImageBase; for (XrSwapchainImageOpenGLESKHR& image : swapchainImageBuffer) {
